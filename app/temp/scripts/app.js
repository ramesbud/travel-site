...
var MobileMenu = function () {
    ...
    _createClass(MobileMenu, [{
        ...
        value: function toggleTheMenu() {
            this.menuContent.toggleClass("site-header__menu-content--isVisible");
...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.headersLinks = (0, _jquery2.default)('.primary-nav a');
    ...
    _createClass(StickyHeader, [{
        ...
        value: function addSmoothScrolling() {
            this.headersLinks.smoothScroll();
        }
    }, {
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction == "down") {
                            ...
                            that.headersLinks.removeClass('is-current-link');
